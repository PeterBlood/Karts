Assets {
    ...
    ObjectBlock {
      ...
      Objects {
        ...
        Equipment {
          ...
          Weapon {
            ProjectileAssetRef {
              Id: 13186346872585905470
            }
            MuzzleFlashAssetRef {
              Id: 5702736050034821551
            }
            TrailAssetRef {
              Id: 841534158063459245
            }
            ImpactAssetRef {
              Id: 12645240409152524651
            }
            Muzzle {
              Location {
              }
  ...
  Marketplace {
    Description: "The Advanced Bow is a weapon that uses a new Core feature called IK Anchors. These anchors are used to put the player in a custom\r\nstance and use custom animations when firing the bow."
  }
